...
const sourceDir = '../ekd-cms/types';
const destinationFolder = 'strapi-types';

const files = [
  {
    src: path.join(__dirname, `./${sourceDir}/generated/contentTypes.d.ts`),
    dest: path.join(__dirname, `./${destinationFolder}/contentTypes.d.ts`),
  },
  {
    src: path.join(__dirname, `./${sourceDir}/generated/components.d.ts`),
